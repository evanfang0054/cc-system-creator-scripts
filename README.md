...
- **⚡ 工作流编排** - 自动化的多代理协作流程
- **📦 代码生成管道** - 端到端的应用程序生成
- **🔌 MCP 服务器开发** - Model Context Protocol 专用服务器构建
- **📚 中文化支持** - 完整的中文文档和调试指南
...
- **标准化 SDK** - 基于 @modelcontextprotocol/sdk 的开发框架
- **调试工具** - 集成 MCP Inspector 的本地调试环境
- **工具定义** - 灵活的工具创建和参数验证
- **环境配置** - 支持 .env 文件和多种配置方式

### 📚 中文化支持

- **完整中文文档** - 项目说明、调试指南、使用示例
- **本地化开发** - 中文错误信息和用户提示
- **Git 中文提交** - 标准化的中文提交规范
- **调试友好** - 详细的中文调试和故障排除指南
...
通过 MCP 服务器实现与 Apifox 的深度集成：

- **API 文档获取**：自动从 Apifox 获取最新的 API 文档
- **接口详情解析**：提取完整的接口参数、响应格式和使用说明
- **开发环境调试**：本地化调试环境，支持实时 API 测试
- **中文化支持**：完整的中文调试指南和错误提示
...
- 使用中文文档和注释提高可维护性
- 遵循 Git 中文提交规范保持版本历史清晰
- 利用 MCP Inspector 进行本地调试和测试
