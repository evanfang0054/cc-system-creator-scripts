...
**测试**：以下示例包含测试任务。测试是可选的 - 仅在功能规范中明确要求时才包含它们。
...
> **注意：先编写这些测试，确保在实现之前它们失败**

- [ ] T010 [P] [US1] [endpoint] 的契约测试，位于 tests/contract/test_[name].py
- [ ] T011 [P] [US1] [user journey] 的集成测试，位于 tests/integration/test_[name].py
...
- [ ] T018 [P] [US2] [endpoint] 的契约测试，位于 tests/contract/test_[name].py
- [ ] T019 [P] [US2] [user journey] 的集成测试，位于 tests/integration/test_[name].py
...
- [ ] T024 [P] [US3] [endpoint] 的契约测试，位于 tests/contract/test_[name].py
- [ ] T025 [P] [US3] [user journey] 的集成测试，位于 tests/integration/test_[name].py
...
- **用户故事 1 (P1)**：可在基础（阶段 2）完成后开始 - 无其他故事依赖
- **用户故事 2 (P2)**：可在基础（阶段 2）完成后开始 - 可与 US1 集成但应可独立测试
- **用户故事 3 (P3)**：可在基础（阶段 2）完成后开始 - 可与 US1/US2 集成但应可独立测试
...
Task: "[endpoint] 的契约测试，位于 tests/contract/test_[name].py"
Task: "[user journey] 的集成测试，位于 tests/integration/test_[name].py"
