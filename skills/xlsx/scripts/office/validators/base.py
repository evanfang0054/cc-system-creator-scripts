...
class BaseSchemaValidator:
    ...
    UNIQUE_ID_REQUIREMENTS = {
        "comment": ("id", "file"),  # 评论
        "commentrangestart": ("id", "file"),  # 评论范围起始
        "commentrangeend": ("id", "file"),  # 评论范围结束
        "bookmarkstart": ("id", "file"),  # 书签起始
        "bookmarkend": ("id", "file"),  # 书签结束
        "sldid": ("id", "file"),  # 幻灯片ID
        "sldmasterid": ("id", "global"),  # 幻灯片母版ID
        "sldlayoutid": ("id", "global"),  # 幻灯片版式ID
        "cm": ("authorid", "file"),  # 评论作者ID
        "sheet": ("sheetid", "file"),  # 工作表
        "definedname": ("id", "file"),  # 定义名称
        "cxnsp": ("id", "file"),  # 连接形状
        "sp": ("id", "file"),  # 形状
        "pic": ("id", "file"),  # 图片
        "grpsp": ("id", "file"),  # 组合形状
    ...
    SCHEMA_MAPPINGS = {
        ...
        "xl": "ISO-IEC29500-4_2016/sml.xsd",  # Excel 工作簿
